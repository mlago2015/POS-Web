...
public class DetalleFacturaPK implements Serializable {
    ...
    public DetalleFacturaPK(int id, int facturaId, String cajero, Date fechaCaja, String codigoCaja, String nombreCaja) {
        this.id = id;
    ...
    public String toString() {
        return "entities.DetalleFacturaPK[ id=" + id + ", facturaId=" + facturaId + ", cajero=" + cajero + ", fechaCaja=" + fechaCaja + ", codigoCaja=" + codigoCaja + ", nombreCaja=" + nombreCaja + " ]";
    }
